...
import cssSafeString from "../css-safe-string";
import {
  Mode,
    ...
    return {
      plugin: function (CodeMirror) {
        ...
        CodeMirror.defineMode("markdown-zkn", function (config, parserConfig) {
          ...
          const pluginMode = CodeMirror.getMode(config, "gfm-joplin-markdown");
          console.log(pluginMode);
          ...
          const mode1 = CodeMirror.overlayMode(
            CodeMirror.getMode(
              config,
